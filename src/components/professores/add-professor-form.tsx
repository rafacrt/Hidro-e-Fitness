...
const specialties = [
  { id: 'natacao_adulto', label: 'Natação Adulto' },
  { id: 'natacao_infantil', label: 'Natação Infantil' },
  { id: 'hidroginastica', label: 'Hidroginástica' },
  { id: 'zumba_aquatica', label: 'Zumba Aquática' },
  { id: 'funcional_aquatico', label: 'Funcional Aquático' },
];
